...
import { Building, Building2, Home as HomeIcon, Landmark, Users } from 'lucide-react';
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                {villaTypes.map((vt) => (
                                    <div key={vt.id} className="flex items-center justify-between rounded-lg bg-white/5 px-4 py-2">
                                        <span className="text-sm text-gray-300">{vt.name}</span>
                                        <span className="text-sm font-semibold text-[#B8860B]">{vt.total_count} units</span>
                                    </div>
                                ))}
                            </div>
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                {towerDefinitions.map((td) => (
                                    <div key={td.id} className="flex items-center justify-between rounded-lg bg-white/5 px-4 py-2">
                                        <span className="text-sm text-gray-300">{td.name}</span>
                                        <span className="text-sm font-semibold text-[#1B4F72]">80 units</span>
                                    </div>
                                ))}
                            </div>
